...
//       if (usersCollection) {
//         console.log("Connection to Users collection established");
//       }
//     } catch (e) {
...
//   static async addLovedPet(userID, petID) {
//     return await usersCollection.updateOne(
//       { _id: new ObjectId(userID) },
//       { $addToSet: { lovedPetsIDs: petID } }
//     );
//   }

//   static async removeLovedPet(userID, petID) {
//     return await usersCollection.updateOne(
//       { _id: new ObjectId(userID) },
//       { $pull: { lovedPetsIDs: petID } }
//     );
//   }
// };
